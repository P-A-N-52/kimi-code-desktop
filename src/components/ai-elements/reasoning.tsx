...
const LazyStreamdownResponse = lazy(() =>
  import("./streamdown-response").then((module) => ({
    default: module.StreamdownResponse,
  })),
);
  ...
  ({ className, children, ...props }: ReasoningContentProps) => {
    return (
      ...
      >
        <Suspense
          fallback={
            <div className="whitespace-pre-wrap break-words" data-kimi-i18n-skip>
              {children}
            </div>
          }
        >
          <LazyStreamdownResponse>{children}</LazyStreamdownResponse>
        </Suspense>
      </CollapsibleContent>
    );
  },
