...
const ZH_CN_TRANSLATIONS: Record<string, string> = {
  ...
  Archive: "归档",
  "Archive all": "归档该项目下的",
  "Archive all project sessions": "归档项目全部会话",
  ...
  "Copied!": "已复制！",
  Copy: "复制",
  "Clipboard unavailable": "当前环境不支持剪贴板",
  "Copy path": "复制路径",
  ...
  Session: "会话",
  Sessions: "会话",
  "Short ID copied": "已复制短 ID",
  "Project actions": "项目操作",
  "Restore all project sessions": "恢复项目全部会话",
  Settings: "设置",
  ...
  "project archive description": "。此操作只改变会话归档状态，不会移动或修改项目文件夹。",
  "?": "？",
