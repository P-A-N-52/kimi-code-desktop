...
const ZH_CN_TRANSLATIONS: Record<string, string> = {
  ...
  Context: "上下文",
  "Back to navigation": "返回导航",
  "No changes": "没有变更",
  "Branch switched": "分支切换完成",
  "Unable to switch branch": "无法切换分支",
  "Commit created": "提交已创建",
  "Commit failed": "提交失败",
  "Push completed": "推送完成",
  "Push failed": "推送失败",
  "Pull request created": "拉取请求已创建",
  "Pull request creation failed": "创建拉取请求失败",
  "Changes relative to branch": "相对分支的变更",
  Agents: "代理",
  ...
  Reject: "拒绝",
  Compare: "比较",
  "commits only on the left": "commits 仅左侧",
  "commits only on the right": "commits 仅右侧",
  "No text diff is available for this file": "该文件没有可显示的文本差异",
  "Commit message": "提交信息",
  files: "个文件",
  ...
  Title: "标题",
  Description: "说明",
  "Create as Draft": "创建为 Draft",
  "Push the latest commits first.": "请先推送最新提交。",
  "This session has no file or media sources": "当前会话没有文件或媒体来源",
  "Refresh context": "刷新上下文",
  "Environment information": "环境信息",
  "The current directory is not a Git repository": "当前目录不是 Git 仓库",
  "GitHub CLI is not signed in": "Github CLI未登录",
  "Check again": "重新检测",
  Local: "本地",
  "Switch branch": "切换分支",
  "Local branches": "本地分支",
  ...
  Switch: "切换",
  "pending push": "待推送",
  "This session has no plans yet": "当前会话还没有计划",
  "User input": "用户输入",
  "Model output": "模型输出",
  "This session has no sources yet": "当前会话还没有来源",
  "View all": "查看全部",
  "Copied!": "已复制！",
  Copy: "复制",
  "Copy path": "复制路径",
