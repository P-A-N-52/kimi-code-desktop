...
外层 Desktop 需要 Node.js 24.15.0 以上、npm 和 Rust stable toolchain。运行不需要安装 Kimi Code CLI；`npm install` 会安装项目固定的 pnpm 10.33.0，用于 nested Source Runtime workspace，不依赖全局 pnpm 或 Corepack。
